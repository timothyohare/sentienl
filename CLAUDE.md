...
Full suite is green (`pytest`): 512 passed, 10 skipped. The skipped tests are non-hermetic `test_polymarket.py` cases that would otherwise try to reach the live API (DNS-blocked here since Polymarket is ACMA-blocked in Australia).
